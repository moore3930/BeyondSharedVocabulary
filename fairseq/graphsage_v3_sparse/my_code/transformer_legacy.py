...
class TransformerModel(TransformerModelBase):
    ...
    @classmethod
    def build_graph_embedding(cls, args, dictionary, embed_dim, graph_path, path=None):
        return super().build_graph_embedding(
            TransformerConfig.from_namespace(args), dictionary, embed_dim, graph_path, path
        )
    ...
    @classmethod
    def build_decoder(cls, args, tgt_dict, embed_tokens, graph_merger=None):
        return super().build_decoder(
            TransformerConfig.from_namespace(args), tgt_dict, embed_tokens, graph_merger
        )


# architectures

@register_model_architecture("transformer_id", "transformer_id")
...
@register_model_architecture("transformer_id", "transformer_iwslt_de_en_id")
