...
#SBATCH -o /home/dwu/workplace/logs/beyond/out.EC30_128K_graphmerge_3hop.2.o
#SBATCH -e /home/dwu/workplace/logs/beyond/out.EC30_128K_graphmerge_3hop.2.e
...
CHECKPOINT_DIR=/ivi/ilps/personal/dwu/checkpoints/beyond/release/EC30-128K-graphmerge-3hop
...
fairseq-train ${DATA_DIR}/fairseq-data-bin-sharded/shard0:${DATA_DIR}/fairseq-data-bin-sharded/shard1:${DATA_DIR}/fairseq-data-bin-sharded/shard2:${DATA_DIR}/fairseq-data-bin-sharded/shard3:${DATA_DIR}/fairseq-data-bin-sharded/shard4 \
    ...
    --distributed-world-size 4 --distributed-num-procs 48 --ddp-comm-hook fp16 \
    --skip-invalid-size-inputs-valid-test \
