...
#SBATCH -o /home/dwu/workplace/logs/beyond/out.EC30_128K_baseline.o
#SBATCH -e /home/dwu/workplace/logs/beyond/out.EC30_128K_baseline.e
...
fairseq-train ${DATA_DIR}/fairseq-data-bin-sharded/shard0:${DATA_DIR}/fairseq-data-bin-sharded/shard1:${DATA_DIR}/fairseq-data-bin-sharded/shard2:${DATA_DIR}/fairseq-data-bin-sharded/shard3:${DATA_DIR}/fairseq-data-bin-sharded/shard4 \
    ...
    --encoder-langtok tgt --arch transformer_vaswani_wmt_en_de_big --encoder-normalize-before --decoder-normalize-before \
    ...
    --ddp-backend no_c10d \
    --save-dir /ivi/ilps/personal/dwu/checkpoints/beyond/release/EC30-baseline \
...
# eval
PAIRS=('en-de' 'en-nl' 'en-sv' 'en-da' 'en-af' 'en-lb' 'en-fr' 'en-es' 'en-it' 'en-pt' 'en-ro' 'en-oc' 'en-ru' 'en-cs' 'en-pl' 'en-bg' 'en-uk' 'en-sr' 'en-hi' 'en-bn' 'en-kn' 'en-mr' 'en-sd' 'en-gu' 'en-ar' 'en-he' 'en-ha' 'en-mt' 'en-ti' 'en-am' 'de-en' 'nl-en' 'sv-en' 'da-en' 'af-en' 'lb-en' 'fr-en' 'es-en' 'it-en' 'pt-en' 'ro-en' 'oc-en' 'ru-en' 'cs-en' 'pl-en' 'bg-en' 'uk-en' 'sr-en' 'hi-en' 'bn-en' 'kn-en' 'mr-en' 'sd-en' 'gu-en' 'ar-en' 'he-en' 'ha-en' 'mt-en' 'ti-en' 'am-en')
